    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', cloudinary.models.CloudinaryField(max_length=255, verbose_name='accused_persons_profile_picture')),
                ('arrest_status', models.CharField(choices=[('Free', 'Free'), ('Convicted', 'Convicted'), ('In Custody', 'In Custody'), ('Out On Bond', 'Out On Bond'), ('Out On Cash Bail', 'Out On Cash Bail')], max_length=50, verbose_name='Arrest Status')),
